...
run_my_script() {
    ...
    ASIA="CGD,MAA,CNX,CGP,CMB,DAC,FUO,FUK,FOC,CAN,HAK,HAN,SJW,SGN,HKG,HYD,ISB,CGK,JSR,TNA,JHB,KNU,KHH,KHI,KTM,KHV,CCU,KJA,KUL,LHE,PKX,LHW,LYA,MFM,MLE,MDL,MNL,BOM,NAG,OKA,DEL,KIX,PAT,PNH,TAO,ICN,SHA,SIN,URT,TPE,TAS,PBH,TSN,NRT,ULN,VTE,KHN,RGN,EVN,JOG,CGO,CGQ,ZGN,CGY,WHU,HYN,COK,XMN,DPS,CNN,SZX,KWE"
    (timeout 600 ./CloudflareST -tl 300 -sl 1 -dn 10 -cfcolo ${ASIA}) || return 1
