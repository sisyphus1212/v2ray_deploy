...
run_my_script() {
    ...
    ./CloudflareST -tl 350 -sl 8 -dn 20 -o ./output  -url https://github.com/SagerNet/sing-box/releases/download/v1.8.0-beta.6/SFM-1.8.0-beta.6-universal.zip -cfcolo ${NO_CHINA_AREA}|| return 1
